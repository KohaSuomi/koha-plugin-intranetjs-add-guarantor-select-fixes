package Koha::Plugin::Fi::KohaSuomi::AddGuarantorSelectFixes;
...
our $metadata = {
    name            => "IntranetUserJS: Add guarantor select view fixes",
    author          => 'Lari Strand',
    ...
    maximum_version => '',
    version         => $VERSION,
    description     => "Moves Select button to the beginning of the table when selecting a guarantor, also removes duplicate patron library",
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/AddGuarantorSelectFixes/";
